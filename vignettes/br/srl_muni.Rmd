...
vignette: >
  %\VignetteIndexEntry{srl_muni}
  %\VignetteEngine{knitr::rmarkdown}
  %\VignetteEncoding{UTF-8}
---

Physical Literacy (Letramento Físico) e Desempenho em Leitura de crianças de escolas do Amazonas: um estudo de associação
...
Desempenho em Leitura. Mede o nível de leitura com base em tempo e acertos na leitura de palavras. Medido pela Pontuação total no teste TDE.
